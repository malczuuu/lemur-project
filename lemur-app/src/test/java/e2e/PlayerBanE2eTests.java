...
class PlayerBanE2eTests implements KafkaAwareTest, PostgresAwareTest {
  ...
  private String registerPlayerStep() {
    ExchangeResult result =
        restClient
            ...
            .body(new PlayerCommand.CreatePlayer("charlie"))
            .exchange()
            .returnResult();
  ...
  private void retrieveRegisteredPlayerStep(String playerId) {
    ...
    PlayerDetails player =
        jsonMapper.readValue(result.getResponseBodyContent(), PlayerDetails.class);
